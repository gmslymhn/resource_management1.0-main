...
export default {
  ...
  methods: {
    ...
    async postUpdateProcessedAssets(applyId,disposeName,applyState,disposeNameId,disposeDescription){
    ...
    currentChange(val){
      ...
      this.pageNum = val
      // this.getAssetsList(val,this.pageSize)
    },
    // 上报列表函数
